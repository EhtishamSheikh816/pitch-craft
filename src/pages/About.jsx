    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="py-16 px-5 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 sm:p-10 rounded-2xl border border-white/10 text-left space-y-6">
            {[
      ...
      {/* CTA Section */}
      <section className="py-20 px-5 sm:px-6 lg:px-8 bg-gray-500/5 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <button className="bg-white text-blue-700 px-8 sm:px-10 py-3 sm:py-4 rounded-full text-lg font-semibold hover:scale-105 hover:shadow-lg transition-all">
